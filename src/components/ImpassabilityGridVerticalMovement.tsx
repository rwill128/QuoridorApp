export function impassabilityGridVerticalMovement(walls: ({ row: number; col: number; orientation: "horizontal" | "vertical"; color: string } | { col: number; orientation: string; color: string; row: number })[]) {
